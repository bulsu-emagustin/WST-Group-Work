...
try {
    ...
    try {
        ...
        $data = [
            ['Aquilla James', 'Dela Cruz', 'Akila', '2024104677@bulsu.edu.ph', null, md5('12345678')],
            ['John Edrick', 'Maigue', 'Edrik', '2024104678@bulsu.edu.ph', null, md5('12345678')],
            ['Ian Gabriel', 'San Pedro', 'Ian', '2024104679@bulsu.edu.ph', null, md5('12345678')],
            ['Bennedict', 'Garma', 'Ben', '2024104680@bulsu.edu.ph', null, md5('12345678')],
            ['Ernesto Jay-r', 'Agustin', 'Ernesto', '2024104681@bulsu.edu.ph', null, md5('12345678')],
     ...
     try {
        ...
        $data_books = [
            ...
            ['Napoleon Bonaparte', 'French military and political leader who rose to prominence during the French Revolution, crowning himself Emperor of the French in 1804.', 'images/NapoleonBonaparte.jpg'],
